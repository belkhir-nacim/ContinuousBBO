...
__all__ = ["ResourcesExhausted", "BoundConstraintError", "Individual",
           "BundledObjectives", "Problem", "MockMultiProcessing", "Cache",
           "min_bound_violated", "max_bound_violated",
           "BoundConstraintsChecker", "project", "reflect", "wrap",
           "BoundConstraintsRepair", "TestProblem"]
...
class Problem(object):
    ...
    def __init__(self, objective_functions,
        ...
        objective_functions : callable or sequence of callables
            ...
            :class:`BundledObjectives <benchmark.base.BundledObjectives>`
    ...
    def evaluate(self, individual):
        ...
        :func:`__call__ <benchmark.base.Problem.__call__>` and directly
...
class MockMultiProcessing:
    ...
    :class:`Problem <benchmark.base.Problem>`. The motivation is to
